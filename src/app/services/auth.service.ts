...
export class AuthService {
  ...
  editUser(user: User): Observable<any> {
    return this.http.put(this.baseRoute + '/users/' + user.id, user, { headers: this.headers, responseType: 'json' });
  }
  ...
  refresh(tokenData: TokenData): Observable<any> {
    return this.http.post(this.baseRoute + '/auth/refresh', tokenData, { headers: this.headers, responseType: 'json' })
  }
